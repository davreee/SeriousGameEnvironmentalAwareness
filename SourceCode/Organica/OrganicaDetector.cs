 ...
 */
public class OrganicaDetector : MonoBehaviour
{
    //Controlador del enemigo al que le pasará la información sobre el jugador
    private OrganicaController controller;
    ...
    void Start()
    {
        controller = transform.parent.gameObject.GetComponent<OrganicaController>();
    }
