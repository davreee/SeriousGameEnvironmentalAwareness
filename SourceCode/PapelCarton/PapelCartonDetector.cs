 ...
 */
public class PapelCartonDetector : MonoBehaviour
{

    //Controlador del enemigo al que le pasará la información sobre el jugador
    private PapelCartonController controller;
    ...
    void Start()
    {
        controller = transform.parent.gameObject.GetComponent<PapelCartonController>();
    }
    ...
    void OnTriggerEnter2D(Collider2D col)
    {
        ...
        {
            controller.enemigoDetectado(col.gameObject.transform);
        }
    }
